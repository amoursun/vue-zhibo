  ...
  <div class="showpage">
      ...
      <transition name="slide">
        <div class="about" v-if="isAbout" >
            ...
            <div class="name">甘延林</div>
            <div class="job">求职意向: <span class="jobWanted">web前端工程师</span></div>
            <div > 
                <p class="job">个人信息: </p>
                <span class="jobDetail">中国矿业大学(本科)</span></br>
                <span class="jobDetail">工作年限: 2年</span></br>
                <span class="jobDetail">计算机科学与技术</span></br>
                <span class="jobDetail">18001164476</span></br>
                <span class="jobDetail">gylssm@126.com</span>
            </div>
            <div>
                <p class="skill">技术栈:</p>
